 ...
 * @param <AnyType>
 */
public class ArrayList2<AnyType extends Comparable<? super AnyType>> implements List3<AnyType> {
     ...
     * @throws IndexOutOfBoundsException
     */
    public void set(int index, Node sLL) throws IndexOutOfBoundsException {
